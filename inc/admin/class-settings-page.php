...
{
    public const OPTION_GROUP   = 'ai_review_settings';
    public const SETTINGS_PAGE  = 'ai-review-settings';
    /**
    ...
    public function init()
    {
        ...
        add_action('admin_enqueue_scripts', array( $this, 'enqueue_test_script' ));
    }
    ...
    public function register_settings()
    {
        ...
        register_setting(
            ...
            array(
                ...
                'default'           => self::get_default_system_prompt(),
                'show_in_rest'      => false,
            )
        );
    ...
    /**
     * Enqueue test connection script on settings page.
     */
    public function enqueue_test_script($hook)
    {
        ...
        wp_enqueue_script(
            'ai-review-settings-test',
            AI_REVIEW_PLUGIN_URL . 'assets/settings-test.js',
            array(),
            AI_REVIEW_VERSION,
            true
        );
